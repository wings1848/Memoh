...
export const SETTINGS_ROUTE_SPECS: SettingsRouteSpec[] = [
  ...
  { name: 'bot-new', path: '/settings/bots/new', loader: () => import('@memohai/web/pages/bots/new.vue') },
  ...
  { name: 'appearance', path: '/settings/appearance', loader: () => import('@memohai/web/pages/appearance/index.vue') },
